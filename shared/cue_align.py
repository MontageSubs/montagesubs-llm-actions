...
#
# Usage / 用法:
#    python cue_align.py --source clean.srt --sdh sdh.srt
#    python cue_align.py --source clean.srt --sdh sdh.srt -o result.json
#    echo '{"source": "...", "sdh": "..."}' | python cue_align.py
#
...
#    $ python cue_align.py --source clean.srt --sdh sdh.srt
#    INFO cue_align: cues mapped: 115/120, unmatched high-confidence cues: 2
...
logger = logging.getLogger("cue_align")
